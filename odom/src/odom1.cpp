...
/*In this code
odometry is calculated using an initial position 0,0,0 and using velocity information from a geometry_msgs::Twist . The velocity of each wheel is calculated, and the position is updated using differential drive kinematics.
*/
